...
class ConsultaControllerTest {
    ...
    @Autowired
    private JacksonTester<DadosAgendamendoConsulta> dadosAgendamendoConsultaJson;
        ...
        var response = mvc
                .perform(
                        post("/consultas")
                            ...
                            .content(dadosAgendamendoConsultaJson.write(
                                    new DadosAgendamendoConsulta(2l, 5l, data, especialidade)
                            ).getJson())
                )
                .andReturn().getResponse();
